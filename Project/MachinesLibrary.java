public class MachinesLibrary {
    ...
    public static TuringMachine EqualBinaryWords(){
        ...
        newTM.addTransition("q4", 'x', "q4", 'x', false);
        newTM.addTransition("q4", '0', "q6", 'x', true);
        newTM.addTransition("q5", 'x', "q5", 'x', true);
        newTM.addTransition("q5", '1', "q6", '0', false);
        newTM.addTransition("q6", '0', "q6", '1', false);
        newTM.addTransition("q6", '1', "q6", 'x', false);
